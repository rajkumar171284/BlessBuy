// Sample Products to Add to Your Firestore Database
// Copy each product object and add it via the Admin Panel at /admin/products
...
/*
INSTRUCTIONS:
1. Go to http://localhost:58974/admin/products
2. Click "Add Product" tab
3. Fill in each product's details
4. Click "Add Product" button

OR use the bulk add feature in the console:

Open browser console (F12) and run:
const products = [ paste the sampleProducts array ];
products.forEach(p => console.log(JSON.stringify(p)));

Then copy-paste each into the form.
*/
